...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_tiktok_pages', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('tiktok_page_name');
            $table->string('tiktok_page_url')->unique();
            $table->unsignedBigInteger('number_of_followers');
            $table->unsignedBigInteger('number_of_page_likes')->nullable();
    ...
    {
        Schema::dropIfExists('scp_tiktok_pages');
    }
};
