...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_whatsapp_groups', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('whatsapp_group_name');
            $table->string('whatsapp_group_url')->nullable();
            $table->unsignedBigInteger('whatsapp_group_members')->nullable();
    ...
    {
        Schema::dropIfExists('scp_whatsapp_groups');
    }
};
