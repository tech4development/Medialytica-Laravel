...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_tiktok_groups', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('tiktok_group_name');
            $table->string('tiktok_group_url')->unique();
            $table->unsignedBigInteger('tiktok_group_members');
    ...
    {
        Schema::dropIfExists('scp_tiktok_groups');
    }
};
