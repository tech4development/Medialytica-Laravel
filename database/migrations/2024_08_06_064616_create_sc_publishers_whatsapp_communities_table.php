...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_whatsapp_communities', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->enum('influencer_type', [
                ...
                'Food Blogger',
                'Travel Blogger'
            ])->default('Whatsapp Influencer');
            $table->string('other_influencer_types')->nullable();
            $table->json('niches_themes');
            $table->string('publishing_time');
            $table->string('paypal_email');
            $table->string('whatsapp_community_name');
            $table->string('whatsapp_community_url')->unique();
            $table->unsignedBigInteger('whatsapp_community_members')->nullable();
    ...
    {
        Schema::dropIfExists('scp_whatsapp_communities');
    }
};
