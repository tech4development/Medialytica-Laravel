...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_twitter_communities', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->enum('influencer_type', [
                ...
                'Food Blogger',
                'Travel Blogger'
            ])->default('Twitter Influencer'); // Set a default value if necessary
            $table->string('other_influencer_types')->nullable();
            $table->json('niches_themes');
            $table->string('publishing_time');
            $table->string('paypal_email');
            $table->string('twitter_community_name');
            $table->string('twitter_community_url')->unique();
            $table->unsignedBigInteger('twitter_community_members');
    ...
    {
        Schema::dropIfExists('scp_twitter_communities');
    }
};
