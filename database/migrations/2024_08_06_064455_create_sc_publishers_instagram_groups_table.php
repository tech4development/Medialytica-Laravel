...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_instagram_groups', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('instagram_group_name');
            $table->string('instagram_group_url')->unique();
            $table->unsignedBigInteger('instagram_group_members');
    ...
    {
        Schema::dropIfExists('scp_instagram_groups');
    }
};
