...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_telegram_groups', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('telegram_group_name');
            $table->string('telegram_group_url')->unique();
            $table->unsignedBigInteger('telegram_group_members');
    ...
    {
        Schema::dropIfExists('scp_telegram_groups');
    }
};
