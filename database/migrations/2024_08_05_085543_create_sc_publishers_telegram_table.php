...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_telegram_channels', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->enum('influencer_type', [
                ...
                'Food Blogger',
                'Travel Blogger'
            ])->default('Telegram Influencer');
            $table->string('other_influencer_types')->nullable();
            $table->json('niches_themes');
            $table->string('publishing_time');
            $table->string('paypal_email');
            $table->string('telegram_channel_name');
            $table->string('telegram_channel_url')->unique();
            $table->unsignedBigInteger('telegram_channel_members')->nullable();
    ...
    {
        Schema::dropIfExists('scp_telegram_channels');
    }
};
