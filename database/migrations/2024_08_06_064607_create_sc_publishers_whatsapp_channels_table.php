...
return new class extends Migration
{
    ...
    {
        Schema::create('scp_whatsapp_channels', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('whatsapp_channel_name');
            $table->string('whatsapp_channel_url')->unique();
            $table->unsignedBigInteger('whatsapp_channel_members')->nullable();
    ...
    {
        Schema::dropIfExists('scp_whatsapp_channels');
    }
};
