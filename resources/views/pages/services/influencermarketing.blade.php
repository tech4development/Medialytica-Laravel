...
@section('content')
 <div class="main-body bg-white">
   ...
   <div class="relative w-full px-4 py-44 sm:px-6 lg:px-8">
    ...
    <div class="flex w-full sm:text-center">
     <p class="mb-8 text-center leading-loose text-white sm:text-lg">
      ...
      <br>
      Secure product placements and brand endorsements from over 10K influencers, bloggers, musicians, TV and radio
      personalities, athletes, DJs, comedians, and actors.
      <br><br>
      Leverage our wide network of nano, micro, macro, and mega influencers to drive traffic and boost your sales.
     </p>
    </div>
   </div>
  </section>
     ...
     <header class="container flex h-full flex-col items-center justify-center px-4 lg:mt-0">
      <div class="w-full text-center">
       ...
       <p class="mb-10 text-xl">
        ...
        <br>
        We have over 10K High-DA influencers and social publishers organized by niche and country.
        <br>
        Our constantly updated database adds top influencers daily, giving you unlimited options.
        <br>
        We are dedicated to helping you achieve exceptional brand visibility within your budget.
   ...
   <div id="features" class="mx-auto max-w-6xl">
    ...
    <ul class="mt-16 grid grid-cols-1 gap-4 text-center text-slate-700 md:grid-cols-3 md:gap-x-4">
     <li class="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-8 shadow-sm"
      ...
      <h3 class="font-display mt-3 text-center font-medium">A live updating database of over 10K influencers and social
       publishers.</h3>
     </li>
     ...
     <li class="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-8 shadow-sm"
      ...
      <h3 class="font-display my-3 font-medium">Filter nano, micro, macro, and mega influencers</h3>
     </li>

     <li class="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-8 shadow-sm"
      style="height: 200px; width: 100%;">
      <img src="https://www.svgrepo.com/show/530444/availability.svg" alt="" class="mx-auto h-10 w-10">
      <h3 class="font-display my-3 font-medium">Diverse content niches</h3>
     </li>
     ...
     <li class="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-8 shadow-sm"
      ...
      <a href="/templates" class="group">
       ...
       <h3 class="font-display group-hover:text-primary-500 my-3 font-medium">An experienced team in influencer marketing
        and media buying</h3>
      </a>
     </li>
     ...
     <li class="flex flex-col items-center justify-center rounded-xl bg-white px-6 py-8 shadow-sm"
      ...
      <a href="/download" class="group">
       ...
       <h3 class="font-display group-hover:text-primary-500 my-3 font-medium"> Genuine influencer outreach and
        authenticity
       </h3>
      </a>
     </li>
  ...
  <div class="mb-10 mt-10 flex w-full items-center justify-center">
   ...
   <h2
    class="mx-4 rounded-xl border-2 border-[#e8e9eb] bg-[#004466] px-4 py-2 text-xl font-bold text-white hover:border-[#b78700] hover:bg-[#b78700] dark:text-white">
    How does our influencer marketing service work?
   </h2>
  ...
  <div class="mx-auto grid justify-center gap-10 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
   ...
   <div class="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200">
    <div class="flex h-[180px] flex-col items-center justify-center rounded-md p-6">
     ...
     <div class="space-y-2 text-center">
      <h3 class="font-bold">Browse our database with over 10K influeners and social publishers</h3>
     </div>
    </div>
   </div>
   ...
   <div class="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200">
    <div class="flex h-[180px] flex-col items-center justify-center rounded-md p-6">
     ...
     <div class="space-y-2 text-center">
      <h3 class="font-bold">Select an influencer and make your order</h3>
     </div>
    </div>
   </div>
   ...
   <div class="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200">
    <div class="flex h-[180px] flex-col items-center justify-center rounded-md p-6">
     ...
     <div class="space-y-2 text-center">
      <h3 class="font-bold">Submit content for publishing</h3>
     </div>
    </div>
   </div>
   ...
   <div class="relative select-none overflow-hidden rounded-lg border bg-white p-2 hover:shadow hover:shadow-teal-200">
    <div class="flex h-[180px] flex-col items-center justify-center rounded-md p-6">
     ...
     <div class="space-y-2 text-center">
      <h3 class="font-bold">Review and approve the campaign</h3>
     </div>
    </div>
   </div>
