...
@section('title', 'For Social Publishers')
...
@section('content')
				<div class="main-body">
								...
								<section
												class="relative w-full bg-[url('https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80')] bg-cover bg-center bg-no-repeat">
												<div
												...
												<div class="relative w-full px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
																<div class="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
																				...
																				<div class="mt-8 flex flex-wrap gap-4 text-center">
																								...
																								<a class="block w-full rounded bg-white px-12 py-3 text-sm font-medium text-rose-600 shadow hover:text-rose-700 focus:outline-none focus:ring active:text-rose-500 sm:w-auto"
																												href="#">
																												Learn More
																								</a>
																				</div>
								...
								<div class="relative space-y-24 overflow-hidden bg-gray-900 pb-32 pt-16">
												<div class="relative">
																<div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
																								...
																								<div>
																												...
																												<div class="mt-6">
																																...
																																<p class="mt-4 text-lg text-gray-300">
																																				The AI product utilizes advanced NLP algorithms to understand and interpret human
																																				language,
																				...
																				<div class="mt-12 sm:mt-16 lg:mt-0">
																								<div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
																												<img class="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
																																src="https://images.unsplash.com/photo-1569144157591-c60f3f82f137" style="color:transparent"
																																loading="lazy" width="647" height="486">
																								</div>
																				</div>
																</div>
												</div>
												...
												<div class="relative">
																<div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
																				<div class="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:px-0 lg:py-16">
																								<div>
																												<div>
																																<span class="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
																																				<svg class="h-8 w-8 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
																				...
																				<div class="mt-12 sm:mt-16 lg:mt-0">
																								<div class="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
																												<img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none"
																																...
																																alt="Inbox user interface" style="color:transparent" loading="lazy" width="647"
																																height="486">
																								</div>
																				</div>
																</div>
												...
												<div class="relative">
																<div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
																				...
																				<div class="mt-12 sm:mt-16 lg:mt-0">
																								<div class="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
																												<img class="w-full rounded-xl shadow-2xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
																																src="https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e" style="color:transparent"
																																loading="lazy" width="646" height="485">
																								</div>
																				</div>
																</div>
												</div>
																...
																<div
																				...
																				<div class="lg:pr-8 lg:pt-4">
																								<div class="lg:max-w-lg">
																												...
																												<p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">An Enterprise API
																												</p>
																												<p class="mt-6 text-lg leading-8 text-gray-600">We've built an API that allows you to scale
																																your podcast
																																production workflow.
																												</p>
																												<dl class="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
																																<div class="relative pl-9">
																																				<dt class="inline font-semibold text-gray-900"><svg
																																				...
																																				<dd class="inline">Inspired by Sendgrid, Mailchimp, and Postmark, we allow you to
																																								create and apply
																																...
																																<div class="relative pl-9">
																																				<dt class="inline font-semibold text-gray-900">
																																								<svg class="absolute left-1 top-1 h-5 w-5 text-indigo-600" aria-hidden="true"
																																												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
																																				...
																																				<dd class="inline">A simple REST API that allows you to create, generate, and manage
																																								your content.</dd>
																																</div>
																																<div class="relative pl-9">
																																				<dt class="inline font-semibold text-gray-900"><svg
																								...
																								<div class="mt-10 flex items-center gap-x-6">
																												...
																												<a class="text-sm font-semibold leading-6 text-gray-700" href="#">Schedule a demo
																								...
																								alt="Product screenshot" width="2432" height="200">
																</div>
												</div>
								</section>
								...
								<section class="bg-gray-900 py-12 text-gray-100 sm:py-12 lg:py-16">
												<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
																<div class="mx-auto max-w-xl text-center xl:max-w-2xl">
																				<h2 class="mb-6 text-3xl font-bold leading-tight text-gray-50 sm:text-4xl xl:text-5xl">We are just
																								getting started!</h2>
																...
																<div
																				class="mx-auto mt-8 grid max-w-4xl grid-cols-1 gap-y-4 text-center sm:mt-12 sm:grid-cols-2 sm:gap-x-8 sm:text-left lg:mt-20 lg:max-w-6xl lg:grid-cols-3">
																				<div class="relative">
																								<div class="absolute -inset-1">
																												<div
																																class="h-full w-full rotate-180 bg-gradient-to-r from-yellow-400 via-pink-500 to-green-600 opacity-30 blur-lg filter">
																												</div>
																								</div>
																								<div class="relative h-full overflow-hidden rounded-xl bg-white shadow-md">
																												<div class="p-9"><svg class="mx-auto h-12 w-12 text-gray-400 sm:mx-0" viewBox="0 0 24 24"
																																				fill="none" xmlns="http://www.w3.org/2000/svg">
																																				<path d="M11 8L20 8" stroke="#111827" stroke-width="2" stroke-linecap="round"></path>
																																				<path d="M4 16L14 16" stroke="#111827" stroke-width="2" stroke-linecap="round">
																																				</path>
																				...
																				<div class="overflow-hidden rounded-xl bg-white shadow-md">
																								<div class="p-9"><svg class="mx-auto h-12 w-12 text-gray-400 sm:mx-0" viewBox="0 0 24 24"
																																...
																																<rect x="11" y="13" width="2" height="6" rx="1"
																																				transform="rotate(90 11 13)" fill="#111827">
																																</rect>
								...
								<section class="">
												<div class="container mx-auto max-w-xl space-y-12 p-6 lg:max-w-7xl lg:px-8">
																<div>
																				<h2 class="text-center text-3xl font-bold sm:text-5xl">New Features</h2>
																				<p class="mx-auto mt-4 max-w-3xl text-center text-xl">Explore the latest features that enhance your
																								learning experience and make it even more exciting.</p>
																</div>
																												...
																												<div class="flex">
																																<div class="flex-shrink-0">
																																				<div class="flex h-12 w-12 items-center justify-center rounded-md">
																																								<svg class="lucide lucide-rocket" xmlns="http://www.w3.org/2000/svg"
																																...
																																<div class="ml-4">
																																				<h4 class="leadi text-lg font-medium">Advanced Learning Algorithms</h4>
																																				<p class="mt-2">Discover our improved learning algorithms that adapt to your
																																								preferences and provide even more personalized learning suggestions.</p>
																																</div>
																												</div>
																												<div class="flex">
																																<div class="flex-shrink-0">
																																				<div class="flex h-12 w-12 items-center justify-center rounded-md">
																																								<svg class="lucide lucide-bookmark-plus" xmlns="http://www.w3.org/2000/svg"
																																												width="24" height="24" viewBox="0 0 24 24" fill="none"
																																												stroke="currentColor" stroke-width="2" stroke-linecap="round"
																																												stroke-linejoin="round">
																																...
																																<div class="ml-4">
																																				<h4 class="leadi text-lg font-medium">Interactive Learning Resources</h4>
																																				<p class="mt-2">Access an extensive library of interactive resources that make your
																																								learning journey engaging and interactive.</p>
																																</div>
																												</div>
																												<div class="flex">
																																<div class="flex-shrink-0">
																																				<div class="flex h-12 w-12 items-center justify-center rounded-md">
																																								<svg class="lucide lucide-video" xmlns="http://www.w3.org/2000/svg"
																																												width="24" height="24" viewBox="0 0 24 24" fill="none"
																																												stroke="currentColor" stroke-width="2" stroke-linecap="round"
																																												stroke-linejoin="round">
																																...
																																<div class="ml-4">
																																				<h4 class="leadi text-lg font-medium">Enhanced Video Streaming</h4>
																																				<p class="mt-2">Experience seamless video integration with enhanced streaming
																																								capabilities, providing a better and more uninterrupted learning experience.</p>
																																</div>
																												</div>
																												<div class="flex">
																																<div class="flex-shrink-0">
																																				<div class="flex h-12 w-12 items-center justify-center rounded-md">
																																								<svg class="lucide lucide-file-question" xmlns="http://www.w3.org/2000/svg"
																																												width="24" height="24" viewBox="0 0 24 24" fill="none"
																																												stroke="currentColor" stroke-width="2" stroke-linecap="round"
																																												stroke-linejoin="round">
																																...
																																<div class="ml-4">
																																				<h4 class="leadi text-lg font-medium">Advanced Quiz Generation </h4>
																																				<p class="mt-2">Take your knowledge testing to the next level with advanced quiz
																																								generation, providing more customization options for your quizzes.</p>
																																</div>
																												</div>
																								</div>
																				</div>
								...
								<div class="min-h-screen bg-gray-700 p-4">
												<div class="mx-auto h-max max-w-7xl px-6 md:px-12 xl:px-6">
																<div class="md:w-2/3 lg:w-1/2">
																				...
																				<svg class="h-6 w-6 text-gray-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
																								fill="currentColor">
																								<path fill-rule="evenodd"
																...
																<div
																				...
																				<div
																								...
																								<div class="relative space-y-8 p-8 py-12">
																												<svg style="color:white" stroke="currentColor" fill="none" stroke-width="2"
																																viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" color="white"
																				...
																				<div
																								...
																								<div class="relative space-y-8 p-8 py-12">
																												...
																												<div class="space-y-2">
																																<h5 class="group-hover:text-secondary text-xl font-semibold text-white transition">Deal
																																				Finalized</h5>
																				...
																				<div
																								...
																								<div class="relative space-y-8 p-8 py-12">
																												...
																												<div class="space-y-2">
																																<h5 class="group-hover:text-secondary text-xl font-semibold text-white transition">Product
																																				Delivery</h5>
																				...
																				<div
																								...
																								<div class="relative space-y-8 p-8 py-12">
																												...
																												<div class="space-y-2">
																																<h5 class="group-hover:text-secondary text-xl font-semibold text-white transition">
								...
								<div class="h-screen dark:bg-gray-800">
												...
												<div
																...
																<div class="col-span-2 mb-8">
																				...
																				<h2 class="mb-4 mt-3 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white md:text-3xl">
																								Trusted
																								by over 600 million users and 10,000 teams</h2>
																				<p class="font-light text-gray-500 dark:text-gray-400 sm:text-xl">Our rigorous security and compliance
																								standards
																				...
																				<div class="mt-6 space-y-4 border-t border-gray-200 pt-6 dark:border-gray-700">
																								<div>
																												<a class="inline-flex items-center text-base font-medium text-purple-500 hover:text-purple-800 dark:text-purple-500 dark:hover:text-purple-700"
																																href="#">
																...
																<div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
																				<div>
																								<svg class="mb-2 h-10 w-10 text-purple-500 dark:text-purple-500 md:h-12 md:w-12"
								...
								<div class="bg-black">
												...
												<section
																class="relative block border-b border-t border-neutral-900 bg-neutral-900/30 px-6 py-10 md:px-10 md:py-20"
																id="features">


																<div class="relative mx-auto max-w-5xl text-center">
																				<span class="my-3 flex items-center justify-center font-medium uppercase tracking-wider text-gray-400">
																								Why choose us
																				</span>
																				<h2
																								class="block w-full bg-gradient-to-b from-white to-gray-400 bg-clip-text text-3xl font-bold text-transparent sm:text-4xl">
																...
																<div class="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
																				<div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
																								<div class="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border"
																												...
																												<svg class="icon icon-tabler icon-tabler-color-swatch" xmlns="http://www.w3.org/2000/svg"
																				...
																				<div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
																								<div class="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border"
																												style="background-image: linear-gradient(rgb(80, 70, 229) 0%, rgb(43, 49, 203) 100%); border-color: rgb(93, 79, 240);">
																												<svg class="icon icon-tabler icon-tabler-bolt" xmlns="http://www.w3.org/2000/svg"
																																width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
																																stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
																																<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
																								...
																								<p class="my-4 mb-0 font-normal leading-relaxed tracking-wide text-gray-400">We build our templates
																												for
																				...
																				<div class="rounded-md border border-neutral-800 bg-neutral-900/50 p-8 text-center shadow">
																								<div class="button-text mx-auto flex h-12 w-12 items-center justify-center rounded-md border"
																												style="background-image: linear-gradient(rgb(80, 70, 229) 0%, rgb(43, 49, 203) 100%); border-color: rgb(93, 79, 240);">
																												<svg class="icon icon-tabler icon-tabler-tools" xmlns="http://www.w3.org/2000/svg"
																																width="24" height="24" viewBox="0 0 24 24" stroke-width="2"
																																stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
																																<path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
																...
																<div class="mt-12 grid items-center gap-6 lg:grid-cols-2 lg:gap-16">
																								...
																								<form>
																												<div class="grid gap-4">
																																...
																																<div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
																																				<div>
																																								...
																																								<input
																																												...
																																												id="hs-firstname-contacts-1" name="hs-firstname-contacts-1" type="text"
																																				...
																																				<div>
																																								...
																																								<input
																																												class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
																																												id="hs-lastname-contacts-1" name="hs-lastname-contacts-1" type="text"
																																...
																																<div>
																																				...
																																				<input
																																								class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
																																								id="hs-email-contacts-1" name="hs-email-contacts-1" type="email"
																																								autocomplete="email" placeholder="Email">
																																</div>

																																<div>
																																				<label class="sr-only" for="hs-phone-number-1">Phone Number</label>
																																				<input
																																								class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
																																								id="hs-phone-number-1" name="hs-phone-number-1" type="text"
																																								placeholder="Phone Number">
																																</div>

																																<div>
																																				<label class="sr-only" for="hs-about-contacts-1">Details</label>
																																				<textarea
																																				    class="block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
																																				    id="hs-about-contacts-1" name="hs-about-contacts-1" rows="4" placeholder="Details"></textarea>
																																</div>
																												</div>
																												<!-- End Grid -->
																				...
																				<div class="divide-y divide-gray-200 dark:divide-neutral-800">
																								...
																								<div class="flex gap-x-7 py-6">
																												<svg class="size-6 mt-1.5 shrink-0 text-gray-800 dark:text-neutral-200"
																												...
																												<div class="grow">
																																...
																																<p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">We're here to help with any
																																				questions or code.</p>
																																<a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:text-gray-800 focus:outline-none dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
																																				href="#">
																																				Contact support
												...
												<div class="mx-auto grid grid-cols-1 gap-8 lg:grid-cols-4">
																...
																<div class="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:col-span-3">
																				...
																				<div class="border-l border-gray-300 pl-4">
																								...
																								<p class="mt-2 text-gray-600 lg:max-h-[200px] lg:min-h-[150px]">
																				...
																				<div class="border-l border-gray-300 pl-4">
																								...
																								<a class="mt-4 inline-block font-semibold text-[#00a651]"
																												href="https://blog.indepthresearch.org/">Learn More →</a>
																				</div>
