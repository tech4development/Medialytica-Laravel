  ...
  <div
   ...
   <h1
    ...
    <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
     ...
     <span class="relative"> For Advertisers</span>
    </span>
   </h1>
   ...
   <div class="grid lg:grid-cols-2 lg:items-center lg:gap-4"> <!-- Reduced gap from 8 to 4 -->
    <div>
     <div class="mt-4 space-y-6"> <!-- Reduced vertical spacing from 12 to 6 -->
      <div class="flex space-x-2"> <!-- Added space-x-2 to reduce horizontal space between items -->
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Browse our database with over 10K publishers</h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Select a site/influencer and make your order</h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Submit content for publishing</h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Make payment</h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Get your content published within 24 hours</h4>
       </div>
      </div>
     </div>
    </div>
    <div aria-hidden="true" class="mt-10 lg:mt-0">
     <img width="600" height="600"
      ...
      class="dark-bg-gray-500 mx-auto rounded-lg shadow-lg" style="color:transparent">
    </div>
   </div>
