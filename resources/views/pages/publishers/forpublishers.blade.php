  ...
  <div
   ...
   <h1
    ...
    <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
     ...
     <span class="relative"> For Publishers</span>
    </span>
   </h1>
    ...
    <div>
     <div class="mt-4 space-y-6"> <!-- Reduced vertical spacing from 12 to 6 -->
      <div class="flex space-x-2"> <!-- Added space-x-2 to reduce horizontal space between items -->
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Create a free publisher account</h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Submit your website/blog details
        </h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Post advertisers' content on your blog/website
        </h4>
       </div>
      </div>
      ...
      <div class="flex space-x-2">
       ...
       <div>
        <h4 class="mt-2 text-lg font-medium">Get paid within 24 hours</h4>
       </div>
      </div>
     </div>
    </div>
