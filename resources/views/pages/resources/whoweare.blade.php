...
@section('content')
 <div class="main-body bg-white">
  ...
  <div class="relative space-y-24 overflow-hidden bg-white pb-32 pt-16">

   <div class="relative">
    <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">

     <!-- Left Column: List (ul) -->
     <div class="mx-auto max-w-xl px-6 lg:col-start-1 lg:mx-0 lg:max-w-none lg:px-0 lg:py-16">
      <div class="-mt-10">
       <h2 class="text-3xl font-bold tracking-tight text-[#004466]">
        We are Medialytica, we connect content creators to advertisers
       </h2>
       <p class="mt-4 text-lg text-black">
        Our team of seasoned professionals has the experience to navigate the ever-evolving digital media landscape with
        admirable efficiency.
       </p>
       <div class="mt-6">
        <a
         class="inline-flex rounded-lg bg-[#004466] px-4 py-1.5 text-base font-semibold leading-7 text-[#b78700] shadow-sm ring-1 ring-[#004466] hover:border-[#b78700] hover:bg-[#b78700] hover:text-white hover:ring-[#b78700]"
         href="/login">
         Discover More
        </a>
       </div>
     ...
     <!-- Right Column: Image -->
     <div class="lg:col-start-2 lg:mt-0">
      <div class="lg:relative lg:m-0 lg:h-full lg:px-0">
       <img
        class="h-[100px] w-[100px] w-[300px] rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-[400px] lg:w-auto lg:max-w-none"
        src="{{ asset('backend/assets/startup.webp') }}" alt="Inbox user interface" style="color:transparent"
   ...
   <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
    <div class="mx-auto max-w-xl px-6 lg:col-start-2 lg:mx-0 lg:max-w-none lg:px-0 lg:py-16">
     <div>
      <div class="-mt-12">
       ...
       <ul class="mt-6 list-none space-y-4 text-lg text-black">
        <li class="flex items-center">
         <svg class="mr-2 h-5 w-5 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
          stroke="currentColor">
       ...
       <div class="mt-10">
        <a
         class="hover:hover-border-[#b78700] inline-flex rounded-lg bg-[#004466] px-4 py-1.5 text-base font-semibold leading-7 text-[#b78700] shadow-sm ring-1 ring-[#004466] hover:border-[#b78700] hover:bg-[#b78700] hover:text-white hover:ring-[#004466]"
         href="/login">
         Learn More
        </a>
       </div>
    ...
    <div class="mt-12 sm:mt-16 lg:mt-0">
     <div class="-ml-48 pr-6 md:-ml-16 lg:relative lg:m-0 lg:h-full lg:px-0">
      <img
       class="w-3/4 rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-full lg:w-auto lg:max-w-none"
       src="{{ asset('backend/assets/why us.webp') }}" alt="Inbox user interface" style="color:transparent"
  ...
  <div class="relative">
   <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
     ...
     <div class="mt-12 sm:mt-16 lg:mt-0">
      ...
      <ul class="mt-6 list-none space-y-4 text-lg text-black">
       <li class="flex items-center">
        ...
        We have taken time to build an extensive network of publishers, media outlets, and influencers. This enables us
        to give you the best rates and placements.
       </li>
       <li class="flex items-center">
        <svg class="mr-2 h-5 w-5 text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
         stroke="currentColor">
    ...
    <!-- Right Column: Image -->
    <div class="lg:col-start-2 lg:mt-12">
     <div class="lg:relative lg:m-0 lg:h-full lg:px-0">
      <img
       class="mt-10 h-[100px] w-[100px] w-[300px] rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:right-0 lg:h-[400px] lg:w-auto lg:max-w-none"
       src="{{ asset('backend/assets/About-banner-Jim-Fahad-Digital.webp') }}" alt="Inbox user interface"
       style="color:transparent" loading="lazy" width="300" height="200">
     </div>
    </div>
 ...
 <!-- Start: Core Values -->
 <section class="bg-[#004466] py-12 text-gray-100 sm:py-12 lg:py-16">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
   <div class="mx-auto max-w-xl text-center xl:max-w-2xl">
    <h2 class="mb-6 text-3xl font-bold leading-tight text-gray-50 sm:text-3xl xl:text-3xl">Our Core Values</h2>
    <p class="mb-4">Our commitment to integrity, transparency, and continuous learning brings excellence to all our
     outreach campaigns and media projects.</p>
   ...
   <div
    ...
    <div class="relative">
     <div class="absolute -inset-1">
      <div
       class="to-green h-full w-full rotate-180 bg-gradient-to-r from-yellow-400 via-pink-500 opacity-30 blur-lg filter">
      </div>
     </div>
     <div class="relative h-full overflow-hidden rounded-xl bg-white shadow-md">
      <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
        ...
        <ellipse cx="7" cy="8" rx="3" ry="3" transform="rotate(90 7 8)"
         stroke="#111827" stroke-width="2" stroke-linecap="round"></ellipse>
        <ellipse cx="17" cy="16" rx="3" ry="3" transform="rotate(90 17 16)"
         stroke="#111827" stroke-width="2" stroke-linecap="round"></ellipse>
       </svg>
       <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">Realtime Collaboration</h3>
       <p class="mt-6 text-base text-black">Collaborate in realtime with other editors in a
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-md">
     <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
      ...
      <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">History of Edits</h3>
    ...
    <div class="relative">
     ...
     <div class="relative h-full overflow-hidden rounded-xl bg-white shadow-md">
      <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
       ...
       <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">Integrations</h3>
       <p class="mt-6 text-base text-black">Step up your designs and workflow with
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-md">
     <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
      ...
      <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">Publish webpage online</h3>
      <p class="mt-6 text-base text-black">Effortlessly publish your webpages online and make
    ...
    <div class="relative">
     ...
     <div class="relative h-full overflow-hidden rounded-xl bg-white shadow-md">
      <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
       ...
       <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">Forms and Data Collection
       </h3>
       <p class="mt-6 text-base text-black">Collect data and information from users with
    ...
    <div class="overflow-hidden rounded-xl bg-white shadow-md">
     <div class="p-9"><svg class="mx-auto h-12 w-12 text-[#004466] sm:mx-0" viewBox="0 0 24 24" fill="none"
      ...
      <h3 class="mt-6 text-2xl font-bold text-[#004466] sm:mt-10">Custom Domains</h3>
      <p class="mt-6 text-base text-black">Attach your own custom domain to your published
 ...
 <div class="bg-white">
  ...
  <section class="relative block px-6 py-10 md:px-10 md:py-20" id="features">
   <div class="relative mx-auto max-w-5xl text-center">
    <span class="my-3 flex items-center justify-center font-medium uppercase tracking-wider text-gray-800">
     Our Mission
    </span>
    <h2 class="text-3xl font-bold text-gray-900 sm:text-4xl">
     We are Medialytica, we connect advertisers to content creators
    </h2>
    <p class="mx-auto my-4 w-full max-w-xl text-center font-medium leading-relaxed tracking-wide text-gray-600">
   ...
   <div class="relative z-10 mx-auto grid max-w-7xl grid-cols-1 gap-10 pt-14 sm:grid-cols-2 lg:grid-cols-3">
    <!-- Card 1 -->
    <div class="rounded-md bg-gray-200 p-8 text-center shadow">
     <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-300">
      <svg class="icon icon-tabler icon-tabler-color-swatch" xmlns="http://www.w3.org/2000/svg" width="24"
     ...
     <h3 class="mt-6 text-gray-800">Customizable</h3>
     <p class="my-4 font-normal leading-relaxed text-gray-600">
    ...
    <div class="rounded-md bg-gray-200 p-8 text-center shadow">
     <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-300">
      <svg class="icon icon-tabler icon-tabler-bolt" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
     ...
     <h3 class="mt-6 text-gray-800">Fast Performance</h3>
     <p class="my-4 font-normal leading-relaxed text-gray-600">
    ...
    <div class="rounded-md bg-gray-200 p-8 text-center shadow">
     <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-300">
      <svg class="icon icon-tabler icon-tabler-tools" xmlns="http://www.w3.org/2000/svg" width="24"
       height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
       stroke-linecap="round" stroke-linejoin="round">
       <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
     ...
     <h3 class="mt-6 text-gray-800">Fully Featured</h3>
     <p class="my-4 font-normal leading-relaxed text-gray-600">
