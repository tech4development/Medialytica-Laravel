...
@section('content')
 <div class="main-body bg-white">
  ...
  <div
   ...
   <h1
    ...
    <span class="relative whitespace-nowrap text-orange-500 dark:text-orange-300">
     ...
     <span class="relative"> What We Do</span>
    </span>
   </h1>
    ...
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
     <div class="lg:pr-8 lg:pt-4">
      <div class="lg:max-w-lg">
       ...
       <dl class="max-w-xl space-y-2 text-base leading-6 text-gray-600 lg:max-w-none">
        <div class="relative pl-9">
         <dt class="inline font-semibold text-gray-900">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
           class="absolute left-1 top-1 h-5 w-5">
           <!-- Circle -->
           <circle cx="12" cy="12" r="10" fill="#004466" />
           <!-- Tick -->
           <path d="M9 12.5l2.5 2.5L15 10" stroke="#b78600" stroke-width="2" stroke-linecap="round"
            stroke-linejoin="round" />
          </svg>
       ...
       <dl class="mt-4 max-w-xl space-y-2 text-base leading-6 text-gray-600 lg:max-w-none">
        <div class="relative pl-9">
         <dt class="inline font-semibold text-gray-900">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
           class="absolute left-1 top-1 h-5 w-5">
          ...
          We expose you to new different ways to monetize your website content such as sponsored posts, banners, and link
          insertion.
         </dt>
        </div>
       ...
       <dl class="mt-4 max-w-xl space-y-2 text-base leading-6 text-gray-600 lg:max-w-none">
        <div class="relative pl-9">
         <dt class="inline font-semibold text-gray-900">
          ...
          We link you up with 10K+ fellow publishers and equip you with new content monetization strategies through
          educational material and industry updates.
         </dt>
        </div>
     ...
     <img src="{{ asset('backend/assets/why us.webp') }}" alt="Product screenshot"
      class="h-auto w-[24rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[32rem] md:-ml-4 lg:-ml-0"
  ...
  <section class="overflow-hidden bg-[#004466] py-8 sm:py-16">
   <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
     <img src="{{ asset('backend/assets/why us.webp') }}" alt="Product screenshot"
      class="h-auto w-[24rem] max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[32rem] md:-ml-4 lg:-ml-0"
     ...
     <div class="lg:pr-8 lg:pt-4">
      <div class="lg:max-w-lg">
       ...
       <dl class="max-w-xl space-y-4 text-base leading-7 text-gray-600 lg:max-w-none">
        <div class="relative pl-9">
