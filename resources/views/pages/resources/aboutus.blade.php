<div class="content relative">
    <div class="flex relative before:bg-primary/80 before:absolute before:w-full before:h-full">
      <img src="../assets/img/png-images/14.jpg" alt="" class="h-[500px] w-full rounded-sm" id="profile-img2">
    </div>
        ...
        <div class="box">
          <div class="box-body">
            <div class="grid xl:grid-cols-2 gap-6">
              <div>
                <img class="rounded-sm" src="../assets/img/gallery/10.jpg" alt="">
              </div>
              <div class="space-y-3">
                  ...
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto">
                        <img alt="testimonial" src="../assets/img/users/2.jpg" class="avatar avatar-sm !rounded-full">
                ...
                <div class="swiper-slide">
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto ">
                        <img alt="testimonial" src="../assets/img/users/12.jpg" class="avatar avatar-sm !rounded-full">
                        <div class="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <div class="swiper-slide">
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto ">
                        <img alt="testimonial" src="../assets/img/users/3.jpg" class="avatar avatar-sm !rounded-full">
                        <div class="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <div class="swiper-slide">
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto ">
                        <img alt="testimonial" src="../assets/img/users/13.jpg" class="avatar avatar-sm !rounded-full">
                        <div class="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <div class="swiper-slide">
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto ">
                        <img alt="testimonial" src="../assets/img/users/5.jpg" class="avatar avatar-sm !rounded-full">
                        <div class="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <div class="swiper-slide">
                  <div class="box mb-0 text-start">
                    <div class="box-body">
                      ...
                      <a class="flex my-auto ">
                        <img alt="testimonial" src="../assets/img/users/15.jpg" class="avatar avatar-sm !rounded-full">
                        <div class="ltr:pl-4 rtl:pr-4 my-auto">
