...
@section('content')
 <div class="main-body bg-white">
  ...
  <nav aria-label="Breadcrumb" class="mb-0 mt-0 flex bg-[#004466] px-4 py-2">
   <ol class="flex items-center whitespace-nowrap text-white">
    ...
    <li class="inline-flex items-center">
     ...
     <svg class="size-4 dark:text-neutral mx-2 shrink-0 text-white" xmlns="http://www.w3.org/2000/svg" width="24"
  ...
  <<div class="w-full bg-[#004466] px-4 py-8">

   <div class="wrap relative overflow-hidden">
    <div class="absolute left-1/2 h-full border-2 border-gray-200 border-opacity-50"></div>

    <!-- Event 1 -->
    <div class="right-timeline mb-8 flex w-full items-center justify-between">
     <div class="order-1 w-5/12"></div>
     <div class="z-20 order-1 flex h-12 w-12 items-center rounded-full bg-[#b78700] shadow-xl">
      <h1 class="mx-auto text-lg font-semibold text-[#004466]">1</h1>
     </div>
     <div
      class="order-1 w-5/12 rounded-lg bg-white px-6 py-4 shadow-xl transition-shadow duration-300 ease-in-out hover:shadow-2xl">
      <h3 class="mb-3 text-xl font-bold text-gray-800">Event Title</h3>
      <p class="leading-tight text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in nisi
       commodo, aliquet velit ac, dapibus elit.</p>
     </div>
    </div>
    ...
    <div class="left-timeline mb-8 flex w-full flex-row-reverse items-center justify-between">
     <div class="order-1 w-5/12"></div>
     <div class="z-20 order-1 flex h-12 w-12 items-center rounded-full bg-[#b78700] shadow-xl">
      <h1 class="mx-auto text-lg font-semibold text-[#004466]">2</h1>
     </div>
     <div
      class="order-1 w-5/12 rounded-lg bg-white px-6 py-4 shadow-xl transition-shadow duration-300 ease-in-out hover:shadow-2xl">
      <h3 class="mb-3 text-xl font-bold text-gray-800">Event Title</h3>
    ...
    <div class="right-timeline mb-8 flex w-full items-center justify-between">
     <div class="order-1 w-5/12"></div>
     <div class="z-20 order-1 flex h-12 w-12 items-center rounded-full bg-[#b78700] shadow-xl">
      <h1 class="mx-auto text-lg font-semibold text-[#004466]">3</h1>
     </div>
     <div
      class="order-1 w-5/12 rounded-lg bg-white px-6 py-4 shadow-xl transition-shadow duration-300 ease-in-out hover:shadow-2xl">
      <h3 class="mb-3 text-xl font-bold text-gray-800">Event Title</h3>
    ...
    <div class="left-timeline mb-8 flex w-full flex-row-reverse items-center justify-between">
     <div class="order-1 w-5/12"></div>
     <div class="z-20 order-1 flex h-12 w-12 items-center rounded-full bg-[#b78700] shadow-xl">
      <h1 class="mx-auto text-lg font-semibold text-[#004466]">4</h1>
     </div>
     <div
      class="order-1 w-5/12 rounded-lg bg-white px-6 py-4 shadow-xl transition-shadow duration-300 ease-in-out hover:shadow-2xl">
      <h3 class="mb-3 text-xl font-bold text-gray-800">Event Title</h3>
    ...
    <div class="right-timeline mb-8 flex w-full items-center justify-between">
     <div class="order-1 w-5/12"></div>
     <div class="z-20 order-1 flex h-12 w-12 items-center rounded-full bg-[#b78700] shadow-xl">
      <h1 class="mx-auto text-lg font-semibold text-[#004466]">5</h1>
     </div>
     <div
      class="order-1 w-5/12 rounded-lg bg-white px-6 py-4 shadow-xl transition-shadow duration-300 ease-in-out hover:shadow-2xl">
      <h3 class="mb-3 text-xl font-bold text-gray-800">Event Title</h3>
      <p class="leading-tight text-gray-700">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in nisi
       commodo, aliquet velit ac, dapibus elit.
       Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum in nisi
       commodo, aliquet velit ac, dapibus elit.</p>
     </div>
    </div>
   </div>
