...
@section('content')
 <div class="main-body bg-white">
  ...
  <!-- Start: Card Section -->
  <!-- Header Section -->
  <div class="mb-4 mt-10 flex w-full items-center justify-center">
   <!-- Left Divider -->
  ...
  <!-- Start:Cards Section -->
  <section class="bg-[#004466] text-white">
   <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    ...
    <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
     <a
      class="block rounded-xl border border-gray-800 p-8 shadow-xl transition hover:border-[#b78700] hover:shadow-[#b78700]"
      href="#">
      <svg xmlns="http://www.w3.org/2000/svg" class="size-10 text-[#b78700]" fill="none" viewBox="0 0 24 24"
       stroke="currentColor">
