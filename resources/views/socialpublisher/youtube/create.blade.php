    ...
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('youtube.store') }}" method="POST">
                ...
                <!-- No of Subscribers -->
                <div class="mb-4">
                    <label for="number_of_subscribers" class="block text-sm font-medium text-gray-700">Enter the number of  subscribers on  your Youtube channel</label>
                    <input type="number" id="number_of_subscribers" name="number_of_subscribers" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <div class="mb-4">
                        ...
                        <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                            ...
                            <div class="flex items-center">
                                <input type="checkbox" id="post_type_shorts" name="postTypes[]" value="shorts" class="mr-2" onchange="toggleDivs()">
