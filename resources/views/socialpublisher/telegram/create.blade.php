...
<head>
    ...
    <title>Telegram Channel Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('scp_telegram.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-4">
                    <label for="telegram_channel_name" class="block text-sm font-medium text-gray-700">Enter your telegram channel name *</label>
                    <input type="text" id="telegram_channel_name" name="telegram_channel_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>
                ...
                <!-- No of followers -->
                <div class="mb-4">
                    <label for="telegram_channel_members" class="block text-sm font-medium text-gray-700">Enter the number of members your  on Telegram Channel</label>
                    <input type="number" id="telegram_channel_members" name="telegram_channel_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
