...
<head>
    ...
    <title>Tiktok Page Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Tiktok Page Details</h1>
            <form action="{{ route('scp_facebook.store') }}" method="POST">
                ...
                <div class="mb-4">
                 ...
                 <!--Tiktok Page Name -->
                 <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Tiktok Page</h2>
                 <div class="mb-4">
                    <label for="tiktok_page_name" class="block text-sm font-medium text-gray-700">Enter your Tiktok page name *</label>
                    <input type="text" id="tiktok_page_name" name="tiktok_page_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!--Tiktok Page URL -->
                <div class="mb-4">
                    <label for="tiktok_page__url" class="block text-sm font-medium text-gray-700">Enter your Tiktok page URL *</label>
                    <input type="url" id="tiktok_page_url" name="tiktok_page_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="number_of_followers" class="block text-sm font-medium text-gray-700">Enter the number of followers on Tiktok Page</label>
                ...
                <!-- No of Likes -->
                <div class="mb-4">
                    <label for="number_of_page_likes" class="block text-sm font-medium text-gray-700">Enter the number of likes on Tiktok Page</label>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <div class="mb-4">
                        <span class="block text-sm font-medium text-gray-700">Which type of posts do you make on yourTiktok page? Select all that apply *</span>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    ...
                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       ...
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Tiktok Posts on your page? *</label>
                     ...
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Tiktok skits on your page? *</label>
                     ...
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_video_ads" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Tiktok video ads on your page? *</label>
