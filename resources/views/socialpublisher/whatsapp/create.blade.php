        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('whatsapp.store') }}" method="POST">
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-4">
                    <label for="whatsapp_group_name" class="block text-sm font-medium text-gray-700">Enter your whatsapp group name *</label>
                    <input type="text" id="whatsapp_group_name" name="whatsapp_group_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Whasapp Page URL -->
                <div class="mb-4">
                    <label for="whtasapp_group__url" class="block text-sm font-medium text-gray-700">Enter your whatsapp group URL *</label>
                    <input type="url" id="whatsapp_group_url" name="whatsapp_group_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>
