...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Whasapp Group Details</h1>
            <form action="{{ route('scp_whatsapp.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-4">
                    <label for="whasapp_page_name" class="block text-sm font-medium text-gray-700">Enter your whasapp page name *</label>
                    <input type="text" id="whasapp_page_name" name="whasapp_page_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Whasapp Page URL -->
                <div class="mb-4">
                    <label for="whasapp_group__url" class="block text-sm font-medium text-gray-700">Enter your whasapp group URL *</label>
                    <input type="url" id="whasapp_group_url" name="whasapp_group_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="whatsapp_group_members" class="block text-sm font-medium text-gray-700">Number of followers on Whasapp Group</label>
                    <input type="number" id="whatsapp_group_members" name="whatsapp_group_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <div class="mb-4">
                        <span class="block text-sm font-medium text-gray-700">Which type of posts do you make on your Whasapp group? Select all that apply *</span>
                ...
                {{-- <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800 text-center">Whasapp Post Rates</h2>

                    <p class="text-gray-600 mb-4 text-center">Indicate how much you charge for posts on Whasapp. All rates should be in USD.</p>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Whasapp Post Rates</h2>

                    <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Whasapp. All rates should be in USD.</p>

                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       <!-- Whasapp Image/Poster/Banner/Text posts Rates -->
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Image/Poster/Banner/Text posts</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Whasapp. All rates should be in USD.</p>
                        <!-- How much do you charge per Whasapp post Per Post -->
                        <div class="mb-4">
                            <label for="cost_per_post" class="block text-sm font-medium text-gray-700">How much do you charge per Whasapp post? *</label>
                        ...
                        <!-- How much do you charge per Whasapp post Per Hour -->
                        <div class="mb-4">
                            <label for="cost_per_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp post per hour? *</label>
                        ...
                        <!-- How much do you charge per Whasapp post Per Day -->
                        <div class="mb-4">
                            <label for="cost_per_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp post per day? *</label>
                        ...
                        <!-- How much do you charge per Whasapp post Per Week -->
                        <div class="mb-4">
                            <label for="cost_per_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp post weekly? *</label>
                        ...
                        <!-- How much do you charge per Whasapp post Per Month -->
                        <div class="mb-4">
                            <label for="cost_per_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp post monthly? *</label>
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whasapp Posts on your group? *</label>
                     ...
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Whasapp Skit Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for skits on Whasapp. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Whasapp post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_skit" class="block text-sm font-medium text-gray-700">How much do you charge per Whasapp  Skit? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_skit_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp skit per hour? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_skit_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp skit per day? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_skit_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp skit weekly? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_skit_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp skit monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whasapp skits on your group? *</label>
                     ...
                     <!-- Whasapp Video Ads Rates -->
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Whasapp Video Ad Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for video ads on Whasapp. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Whasapp post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad" class="block text-sm font-medium text-gray-700">How much do you charge per Whasapp  video ad? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp video ad per hour? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp video ad per day? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp video ad weekly? *</label>
                            ...
                            <!-- How much do you charge per Whasapp post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whasapp video ad monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_video_ads" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whasapp video ads on your group? *</label>
