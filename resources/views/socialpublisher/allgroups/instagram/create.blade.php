...
<head>
    ...
    <title>Insagram Group Details</title>
        ...
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('instagramgroup.store') }}" method="POST">
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-4">
                    <label for="instagram_group_name" class="block text-sm font-medium text-gray-700">Enter your insagram group name *</label>
                    <input type="text" id="instagram_group_name" name="instagram_group_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Insagram Page URL -->
                <div class="mb-4">
                    <label for="instagram_group_url" class="block text-sm font-medium text-gray-700">Enter your insagram group URL *</label>
                    <input type="url" id="instagram_group_url" name="instagram_group_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="instagram_group_members" class="block text-sm font-medium text-gray-700">Enter the number of members on Insagram Group</label>
                    <input type="number" id="instagram_group_members" name="instagram_group_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                {{-- <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800 text-center">Insagram Post Rates</h2>

                    <p class="text-gray-600 mb-4 text-center">Indicate how much you charge for posts on Insagram. All rates should be in USD.</p>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Insagram Post Rates</h2>

                    <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Insagram. All rates should be in USD.</p>

                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       <!-- Insagram Image/Poster/Banner/Text posts Rates -->
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Image/Poster/Banner/Text posts</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Insagram. All rates should be in USD.</p>
                        <!-- How much do you charge per Insagram post Per Post -->
                        <div class="mb-4">
                            <label for="cost_per_post" class="block text-sm font-medium text-gray-700">How much do you charge per Insagram post per post? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Hour -->
                        <div class="mb-4">
                            <label for="cost_per_hour" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram post per hour? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Day -->
                        <div class="mb-4">
                            <label for="cost_per_day" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram post per day? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Week -->
                        <div class="mb-4">
                            <label for="cost_per_week" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram post weekly? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Month -->
                        <div class="mb-4">
                            <label for="cost_per_month" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram post monthly? *</label>
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Insagram Posts on your page? *</label>
                 ...
                 <div  id="reels_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Insagram Reel Rates</h2>

                    <p class="text-gray-600 mb-4">Indicate how much you charge for reels on Insagram. All rates should be in USD.</p>

                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>

                     <!-- Insagram Reels Rates -->
                     <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" >
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Insagram Reels</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for reels on Insagram. All rates should be in USD.</p>
                        <!-- How much do you charge per Insagram post Per Post -->
                        <div class="mb-4">
                            <label for="cost_per_reel" class="block text-sm font-medium text-gray-700">How much do you charge per Insagram reel?*</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Hour -->
                        <div class="mb-4">
                            <label for="cost_per_reel_hour" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram reel per hour? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Day -->
                        <div class="mb-4">
                            <label for="cost_per_reel_day" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram reel per day? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Week -->
                        <div class="mb-4">
                            <label for="cost_per_reel_week" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram rel weekly? *</label>
                        ...
                        <!-- How much do you charge per Insagram post Per Month -->
                        <div class="mb-4">
                            <label for="cost_per_reel_month" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram post monthly? *</label>
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_reels" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Insagram reels on your page? *</label>
                     ...
                     <!-- Insagram Skits Rates -->
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Insagram Skit Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for skits on Insagram. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Insagram post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_skit" class="block text-sm font-medium text-gray-700">How much do you charge per Insagram Skit? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_skit_hour" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram skit per hour? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_skit_day" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram skit per day? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_skit_week" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram skit weekly? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_skit_month" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram skit monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Insagram skits on your page? *</label>
                     ...
                     <!-- Insagram Video Ads Rates -->
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Insagram Video Ad Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for video ads on Insagram. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Insagram post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad" class="block text-sm font-medium text-gray-700">How much do you charge per Insagram  video ad? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_hour" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram video ad per hour? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_day" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram video ad per day? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_week" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram video ad weekly? *</label>
                            ...
                            <!-- How much do you charge per Insagram post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_month" class="block text-sm font-medium text-gray-700">How much do you charge an Insagram video ad monthly? *</label>
