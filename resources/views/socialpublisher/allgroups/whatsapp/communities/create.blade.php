...
<head>
    ...
    <title>Whatsapp Community Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Whatsapp Community Details</h1>
            <form action="{{ route('whatsappcommunity.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Whatsapp Community</h2>
                 <div class="mb-4">
                    <label for="whatsapp_community_name" class="block text-sm font-medium text-gray-700">Enter your whatsapp community name *</label>
                    <input type="text" id="whatsapp_community_name" name="whatsapp_community_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Whatsapp Page URL -->
                <div class="mb-4">
                    <label for="whatsapp_community__url" class="block text-sm font-medium text-gray-700">Enter your whatsapp community URL *</label>
                    <input type="url" id="whatsapp_community_url" name="whatsapp_community_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="whatsapp_community_members" class="block text-sm font-medium text-gray-700">Number of followers on Whatsapp Community</label>
                    <input type="number" id="whatsapp_community_members" name="whatsapp_community_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <div class="mb-4">
                        <span class="block text-sm font-medium text-gray-700">Which type of posts do you make on your Whatsapp community? Select all that apply *</span>
                ...
                {{-- <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800 text-center">Whatsapp Post Rates</h2>

                    <p class="text-gray-600 mb-4 text-center">Indicate how much you charge for posts on Whatsapp. All rates should be in USD.</p>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Whatsapp Post Rates</h2>

                    <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Whatsapp. All rates should be in USD.</p>

                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       <!-- Whatsapp Image/Poster/Banner/Text posts Rates -->
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Image/Poster/Banner/Text posts</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Whatsapp. All rates should be in USD.</p>
                        <!-- How much do you charge per Whatsapp post Per Post -->
                        <div class="mb-4">
                            <label for="cost_per_post" class="block text-sm font-medium text-gray-700">How much do you charge per Whatsapp post? *</label>
                        ...
                        <!-- How much do you charge per Whatsapp post Per Hour -->
                        <div class="mb-4">
                            <label for="cost_per_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp post per hour? *</label>
                        ...
                        <!-- How much do you charge per Whatsapp post Per Day -->
                        <div class="mb-4">
                            <label for="cost_per_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp post per day? *</label>
                        ...
                        <!-- How much do you charge per Whatsapp post Per Week -->
                        <div class="mb-4">
                            <label for="cost_per_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp post weekly? *</label>
                        ...
                        <!-- How much do you charge per Whatsapp post Per Month -->
                        <div class="mb-4">
                            <label for="cost_per_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp post monthly? *</label>
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp Posts on your community? *</label>
                     ...
                     <!-- Whatsapp Skits Rates -->
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Whatsapp Skit Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for skits on Whatsapp. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Whatsapp post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_skit" class="block text-sm font-medium text-gray-700">How much do you charge per Whatsapp  Skit? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_skit_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp skit per hour? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_skit_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp skit per day? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_skit_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp skit weekly? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_skit_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp skit monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp skits on your community? *</label>
                     ...
                     <!-- Whatsapp Video Ads Rates -->
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Whatsapp Video Ad Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for video ads on Whatsapp. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Whatsapp post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad" class="block text-sm font-medium text-gray-700">How much do you charge per Whatsapp  video ad? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp video ad per hour? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_day" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp video ad per day? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_week" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp video ad weekly? *</label>
                            ...
                            <!-- How much do you charge per Whatsapp post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_month" class="block text-sm font-medium text-gray-700">How much do you charge a Whatsapp video ad monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_video_ads" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp video ads on your community? *</label>
