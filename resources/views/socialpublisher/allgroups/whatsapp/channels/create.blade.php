...
<head>
    ...
    <title>Whatsapp Channel Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Whatsapp Channel Details</h1>
            <form action="{{ route('whatsappchannel.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Whatsapp Channel Profile</h2>
                 <div class="mb-4">
                    <label for="whatsapp_channel_name" class="block text-sm font-medium text-gray-700">Enter your whatsapp Channel name *</label>
                    <input type="text" id="whasapp_page_name" name="whatsapp_channel_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Whasapp Page URL -->
                <div class="mb-4">
                    <label for="whatsapp_channel__url" class="block text-sm font-medium text-gray-700">Enter your whatsapp channel URL *</label>
                    <input type="url" id="whatsapp_channel_url" name="whatsapp_channel_url" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="whatsapp_channel_members" class="block text-sm font-medium text-gray-700">Number of followers on Whatsapp Channel</label>
                    <input type="number" id="whatsapp_channel_members" name="whatsapp_channel_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <div class="mb-4">
                        <span class="block text-sm font-medium text-gray-700">Which type of posts do you make on your Whatsapp channel? Select all that apply *</span>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    ...
                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       ...
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp Posts on your channel? *</label>
                     ...
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp skits on your channel? *</label>
                     ...
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_video_ads" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Whatsapp video ads on your channel? *</label>
