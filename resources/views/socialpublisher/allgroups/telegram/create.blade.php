...
<head>
    ...
    <title>Telegram Group Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Telegram Group Details</h1>
            <form action="{{ route('scp_telegramgroup.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <div class="mb-4">
                    <label for="telegram_group_name" class="block text-sm font-medium text-gray-700">Enter your telegram group name *</label>
                    <input type="text" id="telegram_group_name" name="telegram_group_name" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- Telegram Page URL -->
                <div class="mb-4">
                    <label for="telegram_group_url" class="block text-sm font-medium text-gray-700">Enter your telegram Group URL *</label>
                    <input type="url" id="telegram_group_url" name="telegram_group_rl" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                </div>


                <!-- No of followers -->
                <div class="mb-4">
                    <label for="telegram_group_members" class="block text-sm font-medium text-gray-700">Enter the number of members your  on Telegram Group</label>
                    <input type="number" id="telegram_group_members" name="telegram_group_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
                ...
                {{-- <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800 text-center">Telegram Post Rates</h2>

                    <p class="text-gray-600 mb-4 text-center">Indicate how much you charge for posts on Telegram. All rates should be in USD.</p>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Telegram Post Rates</h2>

                    <p class="text-gray-600 mb-4">Indicate how much you charge for posts on Telegram. All rates should be in USD.</p>

                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       <!-- Telegram Image/Poster/Banner/Text posts Rates -->
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                        ...
                        <div class="mb-4">
                            <label for="cost_per_post" class="block text-sm font-medium text-gray-700">How much do you charge per Telegram post per post? *</label>
                        ...
                        <div class="mb-4">
                            <label for="cost_per_hour" class="block text-sm font-medium text-gray-700">How much do you charge a  Telegram post per hour? *</label>
                        ...
                        <div class="mb-4">
                            <label for="cost_per_day" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram post per day? *</label>
                        ...
                        <div class="mb-4">
                            <label for="cost_per_week" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram post weekly? *</label>
                        ...
                        <div class="mb-4">
                            <label for="cost_per_month" class="block text-sm font-medium text-gray-700">How much do you charge per Telegram post monthly? *</label>
                        ...
                        <!-- CPM Rate Posts -->
                        <div class="mb-4">
                            <label for="cpm_rate_posts" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Telegram Posts on your page? *</label>
                     ...
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Telegram Skit Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for skits on Telegram. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Telegram post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_skit" class="block text-sm font-medium text-gray-700">How much do you charge per Telegram post per Skit? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_skit_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram skit per hour? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_skit_day" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram skit per day? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_skit_week" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram skit weekly? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_skit_month" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram skit monthly? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for Telegram skits on your page? *</label>
                     ...
                     <!-- Telegram Video Ads Rates -->
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">Telegram Video Ad Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for video ads on Telegram. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per Telegram post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad" class="block text-sm font-medium text-gray-700">How much do you charge per Telegram post per video ad? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_hour" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram video ad per hour? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_day" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram video ad per day? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_week" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram video ad weekly? *</label>
                            ...
                            <!-- How much do you charge per Telegram post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_month" class="block text-sm font-medium text-gray-700">How much do you charge a Telegram video ad monthly? *</label>
