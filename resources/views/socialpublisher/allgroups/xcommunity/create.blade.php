...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('xcommunity.store') }}" method="POST">
                @csrf
                <!-- Name -->
            ...
            <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                <div class="mb-4">
                    <span class="block text-sm font-medium text-gray-700">Which type of posts do you make on your X page? Select all that apply *</span>
                    <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center">
                            ...
                            <label for="post_type_posts" class="text-gray-600">Image/Poster/Banner/Text posts</label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div  id="posts_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">X Post Rates</h2>
                    ...
                    <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                       <!-- X Image/Poster/Banner/Text posts Rates -->
                       <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                     ...
                     <div  id="skits_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">X Skit Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for skits on X. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per X post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_skit" class="block text-sm font-medium text-gray-700">How much do you charge per Skit on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_skit_hour" class="block text-sm font-medium text-gray-700">How much do you charge a skit per hour on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_skit_day" class="block text-sm font-medium text-gray-700">How much do you charge a skit per day on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_skit_week" class="block text-sm font-medium text-gray-700">How much do you charge a skit weekly on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_skit_month" class="block text-sm font-medium text-gray-700">How much do you charge a skit monthly on X ? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_skits" class="block text-sm font-medium text-gray-700">What is the CPM Rate for X skits on your page? *</label>
                     ...
                     <div id="video_ads_div" class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white" style="display: none;">
                        <h2 class="text-lg font-semibold mb-2 text-gray-800">X Video Ad Rates</h2>

                        <p class="text-gray-600 mb-4">Indicate how much you charge for video ads on X. All rates should be in USD.</p>
                        ...
                        <p class="text-gray-600 mb-4">Kindly provide the rates where applicable.</p>
                           ...
                           <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                            ...
                            <!-- How much do you charge per X post Per Post -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad" class="block text-sm font-medium text-gray-700">How much do you charge a video ad on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Hour -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_hour" class="block text-sm font-medium text-gray-700">How much do you charge a video ad per hour on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Day -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_day" class="block text-sm font-medium text-gray-700">How much do you charge a video ad per day on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Week -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_week" class="block text-sm font-medium text-gray-700">How much do you charge a video ad weekly on X ? *</label>
                            ...
                            <!-- How much do you charge per X post Per Month -->
                            <div class="mb-4">
                                <label for="cost_per_video_ad_month" class="block text-sm font-medium text-gray-700">How much do you charge a video ad monthly on X ? *</label>
                            ...
                            <!-- CPM Rate Posts -->
                            <div class="mb-4">
                                <label for="cpm_rate_video_ads" class="block text-sm font-medium text-gray-700">What is the CPM Rate for X video ads on your page? *</label>
