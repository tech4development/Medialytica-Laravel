...
<head>
    ...
    <title>Facebook Page Details</title>
...
@endif
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            <h1 class="text-2xl font-bold mb-4 text-center">Add your Facebook Page Details</h1>
            <form action="{{ route('facebookpage.store') }}" method="POST">
                @csrf
                <!-- Name -->
                ...
                <div class="mb-4">
                 ...
                 <!-- Facebook Page Name -->
                 <div class="mb-6 p-4 border border-gray-200 rounded-lg shadow-sm bg-white">
                    <h2 class="text-lg font-semibold mb-2 text-gray-800">Facebook Profile</h2>
                 <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="facebook_page_members" class="block text-sm font-medium text-gray-700">Number of members on your Facebook Page</label>
                    <input type="number" id="facebook_page_members" name="facebook_page_members" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" step="1" required>
                </div>
