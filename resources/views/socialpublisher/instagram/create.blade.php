...
<head>
    ...
    <title>Insagram Page Details</title>
    ...
    <div class="container mx-auto p-6 max-w-4xl">
        <div class="bg-white p-8 rounded-lg shadow-md">
            ...
            <form action="{{ route('instagram.store') }}" method="POST">
                ...
                <!-- No of followers -->
                <div class="mb-4">
                    <label for="number_of_followers" class="block text-sm font-medium text-gray-700">Number of followers on Insagram Page</label>
