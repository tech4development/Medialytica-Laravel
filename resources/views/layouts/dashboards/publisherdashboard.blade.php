 ...
 <div class="page">
  ...
  <aside class="app-sidebar" id="sidebar">
   ...
   <div class="main-sidebar-header">
    @yield('sidebar')
    <a href="" class="">
     <img src="{{ asset('backend/assets/img/brand-logos/desktop-logo.png') }}" alt="logo"
      class="main-logo desktop-logo">
     <img src="{{ asset('backend/assets/img/brand-logos/toggle-logo.png') }}" alt="logo"
      class="main-logo toggle-logo">
     <img src="{{ asset('backend/assets/img/brand-logos/desktop-logo.png') }}" alt="logo"
      class="main-logo desktop-dark">
     <img src="{{ asset('backend/assets/img/brand-logos/toggle-dark.png') }}" alt="logo"
   ...
   @if (Auth::user()->user_role === 'publisher')
    <!-- Replace 'editor' with the role you want -->
       ...
       <div class="header-nav-right">
        ...
        <div class="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
         <button id="dropdown-profile" type="button"
          class="hs-dropdown-toggle ti-dropdown-toggle h-8 w-8 flex-shrink-0 gap-2 rounded-full p-0 text-xs shadow-none focus:ring-gray-400 dark:focus:ring-white/10">
         ...
         <div class="hs-dropdown-menu ti-dropdown-menu w-[20rem] border-0" aria-labelledby="dropdown-profile">
          <div class="ti-dropdown-header !bg-primary flex">
           <div class="ltr:mr-3 rtl:ml-3">
            <img class="avatar rounded-full shadow-none !ring-transparent"
          ...
          <div class="ti-dropdown-divider mt-2">
    ...
    <div class="ti-modal-content">
      ...
      <div class="header-search">
       ...
       <div class="relative">
        ...
        <input type="text" id="icon" name="icon"
         class="ti-form-input py-2 focus:z-10 ltr:pl-11 rtl:pr-11" placeholder="Search">
     ...
     <div class="ti-modal-footer">
      <div class="inline-flex rounded-md shadow-sm">
       <button type="button" class="ti-btn-group ti-btn-soft-primary py-1 dark:border-white/10">
        Search
       </button>
       <button type="button" class="ti-btn-group ti-btn-primary py-1 dark:border-white/10">
        Clear Recents
       </button>
      </div>
     </div>
