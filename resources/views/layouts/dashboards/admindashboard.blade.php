...
<head>
    ...
    <style>
        .side-menu__item, .side-menu__label, .block {
            color: white;
        ...
        .side-menu__item:hover, .side-menu__label:hover {
            color: navy;
        }
    </style>
                        ...
                        <li class="slide has-sub">
                            ...
                            <li class="slide has-sub">
                                <a href="javascript:void(0);" class="side-menu__item" id="publishers-menu">
                                    ...
                                    <span class="ml-auto transform transition-transform duration-200" id="publishers-toggle-icon"></span>
                                </a>
            ...
            document.getElementById('import-menu').addEventListener('click', function() {
                ...
                toggleIcon.classList.toggle('rotate-180');
                        ...
                        <li class="slide has-sub">
                            ...
                            <li class="slide has-sub">
                                <a href="{{ route('permissions.show') }}" class="side-menu__item" id="user-permissions-menu">
                                    <i class="ri-map-pin-user-line side-menu__icon"></i>
                                ...
                                <ul id="user-permissions-menu-items" class="hidden mt-2 space-y-1">
                                    <li>
                                        <a href="{{ route('permissions.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">Add Permissions</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('permissions.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">View Permissions</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('permissions.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">Edit Permissions</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('permissions.show') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-200 rounded-md">Manage Permissions</a>
                                    </li>
                                    <!-- Add more items as needed -->
                                </ul>
                            </li>
                ...
                <div class="header-content">
                    ...
                    <div class="responsive-logo">
                        <a class="responsive-logo-dark" href="" aria-label="Brand">
                            <img src="{{asset('../assets/img/brand-logos/desktop-logo.png')}}" alt="logo" class="mx-auto">
                        </a>
                        <a class="responsive-logo-light" href="" aria-label="Brand">
                            <img src="{{asset('../assets/img/brand-logos/desktop-dark.png')}}" alt="logo" class="mx-auto">
                        </a>
                    </div>
...
<script src="{{asset('backend/assets/js/custom.js')}}"></script>
 ...
 <script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function setupMenuToggle(menuButtonId, menuItemsId, iconId, initiallyExpanded = false) {
            ...
            if (initiallyExpanded) {
                ...
                toggleIcon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16"><path d="M3.5 8a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5z"/></svg>';
            } else {
                toggleIcon.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16"><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3a.5.5 0 0 1 .5-.5z"/></svg>';
            }
            ...
            menuButton.addEventListener('click', function () {
                ...
                toggleIcon.innerHTML = isExpanded
                    ? '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16"><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3a.5.5 0 0 1 .5-.5z"/></svg>'
                    : '<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-dash" viewBox="0 0 16 16"><path d="M3.5 8a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 0 1h-8a.5.5 0 0 1-.5-.5z"/></svg>';
            });
        }

        // Set up the menu toggles
        setupMenuToggle('publishers-menu', 'publishers-menu-items', 'publishers-toggle-icon', true); // Expanded by default
