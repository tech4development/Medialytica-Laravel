...
<head>
    ...
    <title>Social Advertiser Login</title>
                        ...
                        <div class="p-4 sm:p-7">
                            <div class="text-center">
                                ...
                                <p class="mt-3 text-sm text-gray-600 dark:text-white/70">
                                    ...
                                    <a class="text-primary decoration-2 hover:underline font-medium" href="{{ route('socialadvertiserregister') }}">
                                        Register here
                                    </a>
                                </p>
                            </div>
                            ...
                            <div class="mt-5">
                                ...
                                <!-- Form -->
                                <div>
                                    <form method="POST" action="{{ route('socialadvertiserlogin') }}" class="space-y-4">
                                        @csrf
                                        <!-- Form Group -->
                                        <div>
