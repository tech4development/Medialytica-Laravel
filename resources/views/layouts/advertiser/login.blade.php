...
<body class="error-page dark:bg-bgdark flex h-full bg-white !py-0">
  ...
  <div class="relative col-span-12 hidden lg:col-span-6 lg:block">
   <div class="cover relative z-[1] h-full w-full p-10">
    <a href="index.html" class="header-logo">
     <img src="../assets/img/brand-logos/desktop-dark.png" alt="logo" class="block ltr:ml-auto rtl:mr-auto">
    </a>
    <div class="authentication-page mx-auto w-full max-w-7xl justify-center p-0">
      ...
      <div class="p-4 sm:p-7">
       <div class="text-center">
        ...
        <p class="mt-3 text-sm text-gray-600 dark:text-white/70">
         ...
         <a class="text-primary font-medium decoration-2 hover:underline" href="{{ route('advertiserregister') }}">
          Register here
         </a>
        </p>
       </div>
       ...
       <div class="mt-5">
        ...
        <!-- Form -->
        <div>
         <form method="POST" action="{{ route('advertiserlogin') }}" class="space-y-4">
          @csrf
          <!-- Form Group -->
          <div>
