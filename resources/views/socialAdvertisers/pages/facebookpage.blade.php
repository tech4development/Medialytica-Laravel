...
<div class="flex flex-col">
    <div class="overflow-x-auto pb-2">
        <div class="inline-block min-w-full align-middle">
            <div class="overflow-hidden border rounded-lg border-gray-300 shadow-sm">
                <form action="{{ route('socialcart.add') }}" method="POST">
                    @csrf
                    <table class="min-w-full divide-y divide-gray-300 text-xs md:text-sm table-fixed">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col" class="w-1/20 py-2 px-1 text-left font-semibold text-gray-900 truncate">
                                    <input type="checkbox" id="select-all" />
                                </th>
                                <th scope="col" class="w-1/5 py-2 px-1 text-left font-semibold text-gray-900 truncate">Name</th>
                                <th scope="col" class="w-1/5 py-2 px-1 text-left font-semibold text-gray-900 truncate">URL</th>
                                ...
                                <th scope="col" class="w-1/10 py-2 px-1 text-left font-semibold text-gray-900 truncate">Influencer Category</th>
                                <th scope="col" class="w-1/10 py-2 px-1 text-left font-semibold text-gray-900 truncate">Language</th>
                                <th scope="col" class="w-1/10 py-2 px-1 text-left font-semibold text-gray-900 truncate">Country</th>
                        ...
                        <tbody class="border-b text-xs md:text-sm text-center text-gray-800">
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                <td class="p-2 md:p-4">
                                    <input type="checkbox" name="selected_publishers[]" value="{{ $facebookspublisher->id }}" class="form-checkbox" />
                                </td>
                                <td class="p-2 md:p-4">
                                ...
                                <td class="p-2 md:p-4">{{ $facebookspublisher->post_types }}</td>
                                <td class="p-2 md:p-4">{{ $facebookspublisher->time }}</td>
                                <td class="p-2 md:p-4">{{ $facebookspublisher->price }}</td>
                                <td class="relative p-2 md:p-4 flex justify-center space-x-2">
                                    <form action="{{ route('socialcart.add', ['publisherId' => $facebookspublisher->id]) }}" method="POST">
                                        @csrf
    ...
    <!-- Pagination Controls -->
    <div class="mt-4">
        {{ $facebookspublishers->links() }} <!-- This will generate pagination links -->
    </div>
</div>
