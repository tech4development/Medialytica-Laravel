...
class ScPublisherInstagramController extends Controller
{
    ...
    public function store(Request $request)
    {
        // Validate the request
         $validatedData = $request->validate([
            ...
            'instagram_page_name' => 'required|string',
            'instagram_page_url' => 'required|string|url',
          ...
          'influencer_category' => [
            ...
            'instagram_page_name' => $request->input('instagram_page_name'),
            'instagram_page_url' => $request->input('instagram_page_url'),
    ...
    $validatedData['price'] = max($prices);
        ...
        $instagramPublisher = ScPublisherInstagram::create($validatedData);
    ...
    public function index()
    {
        ...
        return view('socialAdvertisers.pages.instagrampage', compact('instagramspublishers'));
    }
}
