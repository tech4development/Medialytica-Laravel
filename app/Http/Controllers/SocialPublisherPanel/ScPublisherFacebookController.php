...
class ScPublisherFacebookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'facebook_page_url' => 'required|url|max:255',
            'facebook_page_name' => 'required|url|max:255',
            'influencer_category' => 'required|string',
            'number_of_followers' => 'required|integer',
            'number_of_page_likes' => 'required|integer',
        ...
        ScPublisherFacebook::create($request->all());

        // Redirect with success message
        return redirect()->back()->with('success', 'Publisher details saved successfully.');
    }
}
