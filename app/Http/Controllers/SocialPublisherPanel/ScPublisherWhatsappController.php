...
class ScPublisherWhatsappController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        'influencer_category' => [
         ...
         $validatedData = [
            ...
            'whatsapp_group_name' => $request->input('whatsapp_group_name'),
            'whatsapp_group_url' => $request->input('whatsapp_group_url'),
            'influencer_category' => $request->input('influencer_category'),
            'whatsapp_group_members' => $request->input('whatsapp_group_members'),
    ...
    // Store the highest price in the 'price' column
      $validatedData['price'] = max($prices);
        ...
        ScPublisherWhatsapp::create( $validatedData);

        //return dd($validatedData);

       return redirect()->route('socialpublisher.dashboard')->with('success', 'WhatsApp Details created successfully.');
    ...
    public function index()
    {
        ...
        $whatsappgroupspublishers = ScPublisherWhatsapp::paginate(10);

        // Pass the data to the view
        return view('socialAdvertisers.pages.whatsappgroup', compact('whatsappgroupspublishers'));
    }
