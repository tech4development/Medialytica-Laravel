...
class WhatsappCommunityController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = [
            ...
            'whatsapp_community_name' => $request->input('whatsapp_community_name'),
            'whatsapp_community_url' => $request->input('whatsapp_community_url'),
            'influencer_category' => $request->input('influencer_category'),
            'whatsapp_community_members' => $request->input('whatsapp_community_members'),
    ...
    $validatedData['price'] = max($prices);
        ...
        WhatsappCommunities::create($validatedData);
      ...
      return redirect()->route('socialpublisher.dashboard')->with('success', 'WhatsApp Comumunity details created successfully.');
    }
    ...
    public function index()
    {
        ...
        $whatsappcommunityspublishers = WhatsappCommunities::paginate(10);

        // Pass the data to the view
        return view('socialAdvertisers.pages.whatsappcommunity', compact('whatsappcommu nityspublishers'));
    }
}
