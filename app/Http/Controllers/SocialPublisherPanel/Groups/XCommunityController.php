...
class XCommunityController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validatedData = $request->validate([
            ...
            'twitter_community_url' => 'required|url|unique:scp_twitter_communities,twitter_community_url',  // Ensure unique validation points to the correct table
          ...
          $validatedData = [
            ...
            'twitter_community_name' => $request->input('twitter_community_name'),
             'twitter_community_url' => $request->input('twitter_community_url'),
            'influencer_category' => $request->input('influencer_category'),
            'twitter_community_members' => $request->input('twitter_community_members'),
    ...
    $validatedData['price'] = max($prices);
        ...
        TwitterCommunities::create($validatedData);
      ...
      return redirect()->route('socialpublisher.dashboard')->with('success', 'X Community created successfully.');
    }
    ...
    public function index()
    {
        ...
        $xcommunityspublishers = TwitterCommunities::paginate(10);

        // Pass the data to the view
        return view('socialAdvertisers.pages.xcommunity', compact('xcommunityspublishers'));
    }
}
