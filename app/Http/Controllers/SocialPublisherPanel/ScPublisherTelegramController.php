...
class ScPublisherTelegramController extends Controller
{
    // Method to show the form
    public function create()
    {
        return view('socialpublisher.telegram.create');
    }
     /**
    ...
    public function store(Request $request)
    {
        ...
        $validatedData = $request->validate([
            ...
            'telegram_channel_name' => 'required|string|max:255',
            'telegram_channel_url' => 'required|string|url|max:255',
            'telegram_channel_members' => 'required|integer',
            'influencer_category' => [
            'required',
            Rule::in([
         ...
         $validatedData = [
            ...
            'telegram_channel_name' => $request->input('telegram_channel_name'),
            'telegram_channel_url' => $request->input('telegram_channel_url'),
            'influencer_category' => $request->input('influencer_category'),
            'telegram_channel_members' => $request->input('telegram_channel_members'),
    ...
    $validatedData['price'] = max($prices);
        ...
        // Create a new ScPublisherInstagram record
          ScPublisherTelegram::create($validatedData);
      ...
      //  $telegramPublisher = ScPublisherTelegram::create($validated);
    ...
    public function index()
    {
        ...
        $telegramspublishers =ScPublisherTelegram::paginate(10);

        // Pass the data to the view
        return view('socialAdvertisers.pages.telegramchannel', compact('telegramspublishers'));
    }
